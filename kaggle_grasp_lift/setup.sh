...
if [ ! -e "data/mean_std.pickle" ]; then
    ...
    python python_utils/calc_mean_std.py
    echo "Done"
fi
...
echo $spacer
if [ "$1" ]; then
  python python_utils/modify_data.py -num_val 2 -subsample 3 -subject $1
else
  python python_utils/modify_data.py -num_val 2 -subsample 3
fi
